                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="badge bg-info p-2 px-3"
                                                    id="resend-quotation" data-id="{{ $quotation->id }}"
                                                ...
                                                @can('Manage Quotations')
                                                    <div class="nav-item dropdown display-quotation"
                                                        ...
                                                        <span data-bs-toggle="dropdown"
                                                            class="badge badge-lg  quotation-label py-2 px-3 quotation-{{ $quotation->status == 0 ? 'open' : 'close' }} bg-{{ $quotation->status == 0 ? 'success' : 'danger' }} "
