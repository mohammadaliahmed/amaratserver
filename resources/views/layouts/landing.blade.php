...
<head>
    ...
    <title>{{(App\Models\Utility::getValByName('title_text'))?App\Models\Utility::getValByName('title_text') : config('app.name', 'POSGo')}}</title>
...
<body class="{{ $color }}">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <h2 class="text-white mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        {{ __('Purchase and Sales Management Tool') }}<br />
                    </h2>
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mb-5 mobile-screen">
                <div class="col-auto">
                    <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
                        <!-- <img src="{{ asset(Storage::url('logo/logo-dark.png')) }}" alt="" class="img-fluid" /> -->
                         <img src="{{ $logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') }}"
                        alt="{{ config('app.name', 'Posgo') }}" class="logo logo-lg">
                    </div>
                </div>
            ...
            <img src="{{ asset('landing/posgo-pic-1.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/posgo-pic-1.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-12 text-end ">
                    ...
                    <p class="text-body">{{ __('Copyright') }} {{ env('FOOTER_TEXT') }} | Design By POSGo </p>
                </div>
            </div>
        </div>
    </section>
