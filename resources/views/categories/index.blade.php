...
@section('action-btn')
    @can('Create Category')
        <a href="#" data-ajax-popup="true" data-size="md" data-title="{{ __('Add New Category') }}"
            title="{{ __('Add Category') }}" data-bs-toggle="tooltip" data-url="{{ route('categories.create') }}"
                                                ...
                                                @can('Edit Category')
                                                    <div class="action-btn btn-info ms-2">
                                                        <a href="#" data-ajax-popup="true" data-bs-toggle="tooltip"
                                                            ...
                                                            title="{{ __('Edit Category') }}" data-size="md"
