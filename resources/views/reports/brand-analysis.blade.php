...
@section('page-title', __('Brand Analysis'))

@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Brand Analysis') }}</h5>
    </div>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Brand Analysis') }}</li>
@endsection
                        ...
                        <div class="row input-daterange analysis-datepicker align-items-center">
                            <div class="form-group col-md-3  mb-0">
                                ...
                                <div class="input-group" style="width: 787px;">
                                    ...
                                    {{ Form::hidden('start_date1', null, ['class' => 'form-control', 'id' => 'start-date']) }}
                                    {{ Form::hidden('due_date1', null, ['class' => 'form-control', 'id' => 'end-date']) }} --}}
                            ...
                            <div class="form-group col-md-3  mb-0">
                                {{ Form::label('brand_id', __('Product Brand'), ['class' => 'col-form-label']) }}
                                <div class="input-group">
                                    {{ Form::select('brand_id', $product_brands, null, ['class' => 'form-control','id' => 'brand_id','data-toggle' => 'select']) }}
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            function ajax_product_brand_analysis_filter() {
                ...
                $('#myTable .brand_myTable').DataTable({
                        ...
                        "ajax": {
                            "type": "GET",
                            "url": '{{ route('product.brand.analysis.filter') }}',
                            "data": data,
                        },
                        "columns": [{
                                "data": "id"
