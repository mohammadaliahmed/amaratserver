...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Vendor Analysis') }}</h5>
    </div>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Vendor Analysis') }}</li>
@endsection
                            ...
                            <table class="table dataTable vendor-analysis-datatable" role="grid">
                                ...
                                <tfoot>
                                    {{-- <tr>
                                        ...
                                        <td rowspan="1" colspan="1">
                                            <h5 class="h6" id="totalpurchasedamount"></h5>
                                        </td>
                                    </tr> --}}
                                </tfoot>
                                </tbody>
        ...
        <script type="text/javascript">
            function ajax_product_vendor_analysis_filter() {
                ...
                $('#vendor-analysis-datatable .vendor-analysis-datatable').DataTable({
                        ...
                        "ajax": {
                            "type": "GET",
                            "url": '{{ route('vendor.purchased.analysis.filter') }}',
                            "data": data,
                        },
                        "columns": [{
                                "data": "name"
