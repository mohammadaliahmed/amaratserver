    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class=" btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                ...
                <label
                    class="btn bg-warning p-3 {{ $event->className == 'event-warning' ? 'custom_color_radio_button' : '' }}"><input
                        type="radio" class="d-none" name="className" value="event-warning"
                        {{ $event->className == 'event-warning' ? 'checked' : '' }}></label>
