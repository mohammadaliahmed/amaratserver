                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('return_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none']) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('staff_note', __('Staff Note'), ['class' => 'col-form-label']) }}
                                {{ Form::textarea('staff_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none']) }}
                            </div>
                        </div>
                    </div>
                    ...
                    if ($.inArray(ui.item.id, items) == -1) {
                        ...
                        $('<tr id=' + ui.item.id + '>')
                            .append(
                                ...
                                '<td class="actions">' +
                                '<a class="delete-icon text-white"><i class="fa fa-trash remove-items"></i></a>' +
                                '</td>'
                            )
                            .appendTo($('tbody'));
                        manageTotals();
