...
@section('page-title', __('Create Returns'))

@section('breadcrumb')
         <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
         <li class="breadcrumb-item"><a href="{{ route('productsreturn.index') }}">{{ __('Returns') }}</a></li>
         <li class="breadcrumb-item">{{ __('Create Returns') }}</li>
@endsection

@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Create Returns') }}</h5>
    </div>
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('return_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none' ,'placeholder'=>'Enter return note']) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('staff_note', __('Staff Note'), ['class' => 'col-form-label']) }}
                                {{ Form::textarea('staff_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none' ,'placeholder'=>'Enter staff note']) }}
                            </div>
                        </div>
                    </div>
                    ...
                    if ($.inArray(ui.item.id, items) == -1) {
                        ...
                        $('<tr id=' + ui.item.id + '>')
                            .append(
                                ...
                                '<input type="number" step="1" style="width: 50px" min="1" max="" name="quantity[]" title="{{ __('Quantity') }}" class="input-number" size="4" data-id="' + ui.item.id + '" data-price="' + ui.item.price + '" data-tax="' + ui.item.tax + '" value="' + ui.item.quantity + '">' +
