<?php echo e(Form::open(['url' => 'calendars', 'method' => 'post'])); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <?php echo e(Form::label('start', __('Event start Date'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('start', null, ['class' => 'form-control d_week', 'autocomplete' => 'off'])); ?>

            </div>
        </div>
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <?php echo e(Form::label('end', __('Event End Date'), ['class' => 'col-form-label'])); ?>

                <?php echo e(Form::text('end', null, ['class' => 'form-control d_week', 'autocomplete' => 'off'])); ?>

            </div>
        </div>
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
                <?php echo e(Form::label('className', __('Event Select Color'), ['class' => 'col-form-label d-block mb-3'])); ?>
...
<?php /**PATH C:\wamp65\www\pos\resources\views/calendars/create.blade.php ENDPATH**/ ?>