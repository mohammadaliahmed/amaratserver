                                            ...
                                            <tr>
                                                ...
                                                <td class="Action">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete User')): ?>
                                                        <div
                                                            class="action-btn <?php echo e($user->is_active == 1 ? 'btn-success' : 'btn-danger'); ?> ms-2 ">
                            ...
                            <div class="card-header border-0 pb-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete User')): ?>
                                        <div class="action-btn <?php echo e($user->is_active == 1 ? 'btn-success' : 'btn-danger'); ?> ms-2 ">
                                            <a href="#" data-confirm="<?php echo e(__('Are You Sure?')); ?>"
                                                data-text="Do you want to continue?" data-bs-toggle="tooltip"
                                                data-confirm-yes="status-form-<?php echo e($user->id); ?>"
                                                class="bs-pass-para mx-3 btn btn-sm d-inline-flex align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-4">
                        <a href="#" class="btn-addnew-project  " data-ajax-popup="true"
                            ...
                            <p class="text-muted text-center">
                                <?php if(Auth::user()->parent_id == 0): ?>
                                    <?php echo e(__('Click here to add new Owner')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/users/index.blade.php ENDPATH**/ ?>