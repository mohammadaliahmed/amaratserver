                ...
                <div class="card">
                    <div class="card-header card-body table-border-style">
                        ...
                        <div class="table-responsive" id="expense-table">
                            <table class="table expense_table" id="pc-dt-export" role="grid">
                                <thead>
                                    <tr>
                                        <th>#</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/expenses/index.blade.php ENDPATH**/ ?>