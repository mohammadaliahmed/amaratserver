...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Customer')): ?>
        <a href="#" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip"
           data-title="<?php echo e(__('Add New Customer')); ?>" title="<?php echo e(__(' New Customer')); ?>"
           data-url="<?php echo e(route('customers.create')); ?>" class="btn btn-sm btn-primary btn-icon m-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/customers/index.blade.php ENDPATH**/ ?>