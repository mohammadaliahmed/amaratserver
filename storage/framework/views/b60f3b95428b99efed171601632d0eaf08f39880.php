...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Add Sale')); ?></h5>
    </div>
                            ...
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input id="searchproduct" type="text" data-url="<?php echo e(route('search.products')); ?>"
                                        placeholder="<?php echo e(__('Search Product')); ?>" class="form-control pr-4 rounded-right">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="card card-body carttable cart-product-list" id="carthtml"
                                ...
                                <?php if(session($lastsegment) && !empty(session($lastsegment)) && count(session($lastsegment)) > 0): ?>
                                    <?php $__currentLoopData = session($lastsegment); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row mt-3 d-flex align-items-center" data-product-id="<?php echo e($id); ?>"
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <span
                                                            class="price"><?php echo e(Auth::user()->priceFormat($details['price'])); ?></span>
                                                    </div>
                                                    <div class="col-sm-5 mt-2">
                                                        <span class="quantity buttons_added">
                                                            <input type="button" value="-" class="minus">
                                                            <input type="number" step="1" min="1" max="" name="quantity"
                                                                style="width: 50px" title="<?php echo e(__('Quantity')); ?>"
                                                    ...
                                                    <div class="col-sm-3 mt-2" style="margin-left: -19px;">
                                                        <span
                                                    ...
                                                    <div class="col-sm-2 mt-2">
                                                        <a href="#" class="action-btn bg-danger bs-pass-para"
                                                            ...
                                                            <i class="ti ti-trash ti ti-trash text-white mx-3 btn btn-sm" title="<?php echo e(__('Delete')); ?>"></i>
                                                        </a>
                            ...
                            <div class="card carts card-body col" style="margin-top: 3px;">
                                ...
                                <div class="tab-content mt-2" id="btn-pur">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <button type="button" class="btn btn-primary rounded" style="width: 100%" data-ajax-popup="true" data-size="lg"
                                                data-align="centered" data-url="<?php echo e(route('sales.create')); ?>"
                                                data-title="<?php echo e(__('Sale Products')); ?>"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="tab-content  btn-empty text-center">
                                                <a href="#" class="btn btn-danger bs-pass-para rounded" style="width: 100%" data-toggle="tooltip"
                                                    data-original-title="<?php echo e(__('Empty Cart')); ?>"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <span
                            class="select-warning border border-warning"><?php echo e(__('Please select Branch and Cash Register.')); ?></span>

                        <div class="d-none branch-warning warning alert alert-warning alert-dismissible fade show mt-3"
                            role="alert">
                            <span class="alert-icon"><i class="fa fa-exclamation-triangle"></i></span>
                            <span class="alert-text">
                                <strong> <?php echo e(__('Please add some')); ?> <a
                                        href="<?php echo e(route('branches.index')); ?>"><?php echo e(__('Branches')); ?></a> <?php echo e(' and '); ?>

                                    <a href="<?php echo e(route('cashregisters.index')); ?>"><?php echo e(__('Cash Registers')); ?></a></strong>
                            </span>
                        </div>
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    if (data.length == 0) {
                                        ...
                                        $('#branchModal .branch-warning').removeClass(
                                            'd-none');
                                    } else {
                                ...
                                error: function(data) {
                                    ...
                                    show_toastr('<?php echo e(__('Error')); ?>', data.message,
                                        'error');
                                }
                            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/sales/index.blade.php ENDPATH**/ ?>