                                ...
                                <tbody>
                                    <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="badge bg-info p-2 px-3"
                                                    id="resend-quotation" data-id="<?php echo e($quotation->id); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Quotations')): ?>
                                                    <div class="nav-item dropdown display-quotation"
                                                        ...
                                                        <span data-bs-toggle="dropdown"
                                                            class="badge badge-lg  quotation-label py-2 px-3 quotation-<?php echo e($quotation->status == 0 ? 'open' : 'close'); ?> bg-<?php echo e($quotation->status == 0 ? 'success' : 'danger'); ?> "
                                            ...
                                            <td class="Action">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Quotations')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        <a href="#" class="bs-pass-para mx-3 btn btn-sm d-inline-flex align-items-center"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/quotations/index.blade.php ENDPATH**/ ?>