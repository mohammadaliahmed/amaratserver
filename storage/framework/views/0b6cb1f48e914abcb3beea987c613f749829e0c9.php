<?php $__env->startSection('page-title', __('Brand Analysis')); ?>

<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Brand Analysis')); ?></h5>
    </div>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Brand Analysis')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        document.querySelector("#pc-daterangepicker-1").flatpickr({
            ...
            onChange: function(selectedDates, dateStr, instance) {
                ...
                if (dates.length == 1) {
                    ...
                    $('end_date1').val(end);
                    if (typeof ajax_product_brand_analysis_filter == 'function') {
                        ajax_product_brand_analysis_filter();
                    }
                }
            }
        });
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Brand')): ?>
                ...
                <div class="card collapse multi-collapse">
                    <div class="card-body py-3">
                        <div class="row input-daterange analysis-datepicker align-items-center">
                            ...
                            <div class="form-group col-md-3  mb-0">
                                <?php echo e(Form::label('brand_id', __('Product Brand'), ['class' => 'col-form-label'])); ?>

                                <div class="input-group">
                                    <?php echo e(Form::select('brand_id', $product_brands, null, ['class' => 'form-control','id' => 'brand_id','data-toggle' => 'select'])); ?>
                ...
                <div class="card table-card">
                    <div class="card-header card-body table-border-style">
                        ...
                        <div class="col-sm-12 table-responsive table_over" id="myTable">
                            <table class="table dataTable brand_myTable" role="grid">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            function ajax_product_brand_analysis_filter() {
                ...
                $('#myTable .brand_myTable').DataTable({
                        "destroy": true,
                        "paging": true,
                        "ordering": false,
                        "processing": true,
                        ...
                        "ajax": {
                            "type": "GET",
                            "url": '<?php echo e(route('product.brand.analysis.filter')); ?>',
                            "data": data,
                        },
                        "columns": [{
                                "data": "id"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/reports/brand-analysis.blade.php ENDPATH**/ ?>