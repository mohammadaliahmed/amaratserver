                                ...
                                <div class="card">
                                    <div class="card-header card-body">
                                        <div class="row text-xs">
                                            <?php if($emailTemplate->slug=='user_create'): ?>
                                                <div class="row">         
                                                ...
                                                <?php elseif($emailTemplate->slug=='owner_create'): ?>
                                                <div class="row">                           
                                                    <p class="col-6"><?php echo e(__('App Name')); ?> : <span class="pull-end text-primary">{app_name}</span></p>
                                                    <p class="col-6"><?php echo e(__('App Url')); ?> : <span class="pull-right text-primary">{app_url}</span></p>
                                            ...
                                            <?php elseif($emailTemplate->slug=='customer_create'): ?>
                                                <div class="row">
                                                    <p class="col-6"><?php echo e(__('App Name')); ?> : <span class="pull-end text-primary">{app_name}</span></p>
                                                    <p class="col-6"><?php echo e(__('App Url')); ?> : <span class="pull-right text-primary">{app_url}</span></p>
                                            ...
                                            <?php elseif($emailTemplate->slug=='vendor_create'): ?>
                                                <div class="row">
                                                    <p class="col-6"><?php echo e(__('App Name')); ?> : <span class="pull-end text-primary">{app_name}</span></p>
                                                    <p class="col-6"><?php echo e(__('App Url')); ?> : <span class="pull-right text-primary">{app_url}</span></p>
                                            ...
                                            <?php elseif($emailTemplate->slug=='quotations_create'): ?>
                                                <div class="row">
                                                    <p class="col-6"><?php echo e(__('App Name')); ?> : <span class="pull-end text-primary">{app_name}</span></p>
                                                    <p class="col-6"><?php echo e(__('App Url')); ?> : <span class="pull-right text-primary">{app_url}</span></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/email_templates/show.blade.php ENDPATH**/ ?>