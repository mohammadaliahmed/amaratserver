...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Expense Category')): ?>
        <a class="btn btn-sm btn-primary btn-icon " data-bs-toggle="tooltip" data-ajax-popup="true"
            data-title="<?php echo e(__('Add New Category')); ?>" data-url="<?php echo e(route('expensecategories.create')); ?>"
            title="<?php echo e(__('Add Category')); ?>"><span class="btn-inner--icon"><i class="ti ti-plus text-white"></i></span></a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Categories List')); ?></li>
<?php $__env->stopSection(); ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Expense Category')): ?>
                                                    <div class="action-btn btn-info ms-2">
                                                        <a href="#" data-ajax-popup="true" data-bs-toggle="tooltip"
                                                            data-title="<?php echo e(__('Edit Category')); ?>" title="<?php echo e(__('Edit')); ?>"
                                                            data-url="<?php echo e(route('expensecategories.edit', $expensecategory->id)); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Expense Category')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        <a href="#"
                                                            ...
                                                            title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__('Are You Sure?')); ?>"
                                                            data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>"
                                                            data-confirm-yes="delete-form-<?php echo e($expensecategory->id); ?>">
                                                            <i class="ti ti-trash text-white"></i>
                                                        </a>

                                                    </div>
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['expensecategories.destroy', $expensecategory->id], 'id' => 'delete-form-' . $expensecategory->id]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/expensecategories/index.blade.php ENDPATH**/ ?>