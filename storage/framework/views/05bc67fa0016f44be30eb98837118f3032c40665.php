                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('return_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none' ,'placeholder'=>'Enter return note'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('staff_note', null, ['class' => 'form-control', 'rows' => 3, 'style' => 'resize: none' ,'placeholder'=>'Enter staff note'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/productsreturns/create.blade.php ENDPATH**/ ?>