...
<body class="<?php echo e($color); ?>">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://codecanyon.net/item/posgo-purchase-and-sales-management-tool/26199807" class="btn btn-outline-light" target="_blank"><i
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mb-5 mobile-screen">
                <div class="col-auto">
                    <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
                        <!-- <img src="<?php echo e(asset(Storage::url('logo/logo-dark.png'))); ?>" alt="" class="img-fluid" /> -->
                         <img src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')); ?>"
                        alt="<?php echo e(config('app.name', 'Posgo')); ?>" class="logo logo-lg">
                    </div>
                </div>
            ...
            <img src="<?php echo e(asset('landing/posgo-pic-1.png')); ?>" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('landing/posgo-pic-1.png')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> All in one place POSGo
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-12 text-end ">
                    ...
                    <p class="text-body"><?php echo e(__('Copyright')); ?> <?php echo e(env('FOOTER_TEXT')); ?> | Design By POSGo </p>
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH C:\wamp65\www\pos\resources\views/layouts/landing.blade.php ENDPATH**/ ?>