...
<?php $__env->startSection('page-title', __('Add Purchases')); ?>

<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Add Purchases')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Add Purchases')); ?></li>
<?php $__env->stopSection(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <button type="button" class="btn btn-primary rounded" style="width: 100%"
                                                ...
                                                data-url="<?php echo e(route('purchases.create')); ?>"
                                                data-title="<?php echo e(__('Purchase Products')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/purchases/index.blade.php ENDPATH**/ ?>