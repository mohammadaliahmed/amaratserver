...
<div class="modal-body">
    <div class="form-group">
        ...
        <?php echo e(Form::text('date', null, ['class' => 'form-control', 'id' => 'date', 'placeholder' => __('Select Date'), 'readonly' => ''])); ?>
...
<?php /**PATH C:\wamp65\www\pos\resources\views/expenses/create.blade.php ENDPATH**/ ?>