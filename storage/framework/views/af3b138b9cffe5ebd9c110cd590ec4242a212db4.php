<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Purchases')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('action-btn'); ?>
    <a class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse" data-bs-target=".multi-collapse"
        data-bs-toggle="tooltip" title="<?php echo e(__('Filter')); ?>"> <i class="ti ti-filter text-white"></i> </a>

    <a href="<?php echo e(route('Purchase.export')); ?>" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip"
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Purchase list')); ?></li>
<?php $__env->stopSection(); ?>
                ...
                <div class="card collapse multi-collapse">
                    <div class="card-body p-3">
                        <div class="row input-daterange analysis-datepicker align-items-center">
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <?php echo e(Form::label('purchased_from', __('Purchased From'), ['class' => 'form-control-label'])); ?>

                                <div class="input-group">
                                    <?php echo e(Form::select('purchased_from', $vendors, null, ['class' => 'form-control', 'id' => 'purchased_from', 'data-toggle' => 'select'])); ?>

                                </div>
                            </div>
                            <div class="form-group col-md-4 mb-0">
                                <?php echo e(Form::label('purchased_by', __('Purchased By'), ['class' => 'form-control-label'])); ?>

                                <div class="input-group">
                                    <?php echo e(Form::select('purchased_by', $users, null, ['class' => 'form-control', 'id' => 'purchased_by', 'data-toggle' => 'select'])); ?>
                            ...
                            <table class="table dataTable" id="myTable" role="grid">
                                <thead class="thead-light">
                                    <tr role="row">
                                        ...
                                        <th><?php echo e(__('Purchased By')); ?></th>
                                        <th><?php echo e(__('Purchase From')); ?></th>
                                        <th><?php echo e(__('Items Purchased')); ?></th>
                                        <th><?php echo e(__('Total')); ?></th>
                                        <th><?php echo e(__('Payment Status')); ?></th>
                                        <th class="text-center" style="width: 180px;"><?php echo e(__('Action')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/reports/purchase.blade.php ENDPATH**/ ?>