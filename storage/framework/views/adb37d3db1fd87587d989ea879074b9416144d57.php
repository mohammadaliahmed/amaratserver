<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Customer Analysis')); ?></h5>
    </div>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Customer Analysis')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <script type="text/javascript">
            function ajax_product_customer_analysis_filter() {
                ...
                $('#customer-analysis-datatable .customer-analysis-datatable').DataTable({
                        ...
                        "ajax": {
                            "type": "GET",
                            "url": '<?php echo e(route('customer.sales.analysis.filter')); ?>',
                            "data": data,
                        },
                        "columns": [{
                                "data": "name"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp65\www\pos\resources\views/reports/customer-sales.blade.php ENDPATH**/ ?>